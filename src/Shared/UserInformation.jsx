...
const UserInformation = () => {
    ...
    return (
        <div className='max-w-screen-xl mx-auto mt-7 mb-7 flex flex-col sm:flex-row gap-2.5 items-start'>
            {(
                        ...
                        <div className={`bg-second dark:bg-second-dark p-1 rounded-xl relative w-fit`}>
                            {
                                isEdit ?
                                    <>
                                        <input type='file' accept='image/*' className='absolute top-0 left-0 w-full h-full opacity-0' onChange={(e) => handleImageChange(e)} />
                                        <img src={user.image || assets.add_user} alt='user' id='userImage' className={`w-52 max-w-96 rounded-xl`} />
                                    </>
                                    : <img src={user && user.image || assets.user_icon} alt='user' id='userImage' className={`w-52 max-w-96 rounded-xl`} />
                            }
                        </div>
                        <div className={`w-full`}>
                            {
                                isEdit ?
                                    ...
                                    :
                                    <div>
                                        <p className={`font-bold text-3xl text-black dark:text-second`}>{user && user.name || 'User Name'}</p>
                                        <p className={`font-[400] text-[18px] text-title`}>{user && user.email || 'test.user@example.com'}</p>
                                        <p className={`font-[400] text-[18px] text-title`}>{user && user.phone || '01234567890'}</p>
                                    </div>
                            }
                        </div>
                    </div>
                                    ...
                                    {showSettingsList &&
                                        <ul
                                            ...
                                            <li onClick={() => {
                                                ...
                                                className={`p-0.5 cursor-pointer transition text-black dark:text-white  hover:text-main hover:bg-gray-50 dark:hover:bg-[#696969] py-.5 px-1.5 rounded-[4px] `}>{t('Log out')}</li>
                                        </ul>
                                    }
                                </div>
                        }
