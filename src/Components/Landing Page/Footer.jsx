            ...
            <div className={` max-w-screen-xl mx-auto flex flex-col relative z-50 `}>
                <div className='flex flex-row justify-between gap-3 flex-wrap pt-6 pb-6 pl-4 pr-4'>
                    <div>
                        ...
                        <p className='max-w-[400px]  text-lg font-[400] text-[#999999]'>{t('Detect defects in PCBs, highlight them in the image, and help companies improve production accuracy on their lines')}</p>
                    </div>
                            ...
                            NavBar.map((item, index) => (
                                <li key={index} className=' p-.5 cursor-pointer'>
                                    <a href={item.path}
                                        ...
                                        className=" cursor-pointer text-lg font-[400] text-[#999999] hover:text-main "  >{t(item.text)}</a>
                                </li>
                            ))
                        }
                    </ul>
                    <div className='flex gap-1 '>
                        <div className='p-2 bg-second h-fit'>
                            <img src={assets.pcb} className='w-40 ' />
                        </div>
                        <div className='p-2 bg-second h-fit'>
                            <img src={assets.pcb2} className='w-40' />
                        </div>
                    </div>
                </div>
                <div className='flex flex-col  justify-center items-center text-center text-base font-[400] text-[#999999]'>
                    <hr className='w-full' />
